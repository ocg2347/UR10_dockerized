...
"""
This is created to use Logitech RumblePad 2 @ Boun CoLoRs Lab to control UR10
Note: Y-Axes are reverted!
"""
class LogitechRumblePad2(Gamepad):
    fullName = 'Logitech RumblePad 2'
