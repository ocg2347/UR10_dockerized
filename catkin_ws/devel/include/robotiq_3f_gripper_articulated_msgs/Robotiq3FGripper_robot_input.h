// Generated by gencpp from file robotiq_3f_gripper_articulated_msgs/Robotiq3FGripper_robot_input.msg
// DO NOT EDIT!


#ifndef ROBOTIQ_3F_GRIPPER_ARTICULATED_MSGS_MESSAGE_ROBOTIQ3FGRIPPER_ROBOT_INPUT_H
#define ROBOTIQ_3F_GRIPPER_ARTICULATED_MSGS_MESSAGE_ROBOTIQ3FGRIPPER_ROBOT_INPUT_H
...
struct Robotiq3FGripper_robot_input_
{
  ...
  typedef boost::shared_ptr< ::robotiq_3f_gripper_articulated_msgs::Robotiq3FGripper_robot_input_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::robotiq_3f_gripper_articulated_msgs::Robotiq3FGripper_robot_input_<ContainerAllocator> const> ConstPtr;

}; // struct Robotiq3FGripper_robot_input_

typedef ::robotiq_3f_gripper_articulated_msgs::Robotiq3FGripper_robot_input_<std::allocator<void> > Robotiq3FGripper_robot_input;

typedef boost::shared_ptr< ::robotiq_3f_gripper_articulated_msgs::Robotiq3FGripper_robot_input > Robotiq3FGripper_robot_inputPtr;
typedef boost::shared_ptr< ::robotiq_3f_gripper_articulated_msgs::Robotiq3FGripper_robot_input const> Robotiq3FGripper_robot_inputConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::robotiq_3f_gripper_articulated_msgs::Robotiq3FGripper_robot_input_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::robotiq_3f_gripper_articulated_msgs::Robotiq3FGripper_robot_input_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::robotiq_3f_gripper_articulated_msgs::Robotiq3FGripper_robot_input_<ContainerAllocator1> & lhs, const ::robotiq_3f_gripper_articulated_msgs::Robotiq3FGripper_robot_input_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::robotiq_3f_gripper_articulated_msgs::Robotiq3FGripper_robot_input_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::robotiq_3f_gripper_articulated_msgs::Robotiq3FGripper_robot_input_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::robotiq_3f_gripper_articulated_msgs::Robotiq3FGripper_robot_input_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::robotiq_3f_gripper_articulated_msgs::Robotiq3FGripper_robot_input_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::robotiq_3f_gripper_articulated_msgs::Robotiq3FGripper_robot_input_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::robotiq_3f_gripper_articulated_msgs::Robotiq3FGripper_robot_input_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::robotiq_3f_gripper_articulated_msgs::Robotiq3FGripper_robot_input_<ContainerAllocator> >
{
  ...
  static const char* value(const ::robotiq_3f_gripper_articulated_msgs::Robotiq3FGripper_robot_input_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x4d0701156e580a42ULL;
  static const uint64_t static_value2 = 0x0c48833f57bc83f3ULL;
};

template<class ContainerAllocator>
struct DataType< ::robotiq_3f_gripper_articulated_msgs::Robotiq3FGripper_robot_input_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::robotiq_3f_gripper_articulated_msgs::Robotiq3FGripper_robot_input_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::robotiq_3f_gripper_articulated_msgs::Robotiq3FGripper_robot_input_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::robotiq_3f_gripper_articulated_msgs::Robotiq3FGripper_robot_input_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::robotiq_3f_gripper_articulated_msgs::Robotiq3FGripper_robot_input_<ContainerAllocator>& v)
  {
    s << indent << "gACT: ";
...
#endif // ROBOTIQ_3F_GRIPPER_ARTICULATED_MSGS_MESSAGE_ROBOTIQ3FGRIPPER_ROBOT_INPUT_H
