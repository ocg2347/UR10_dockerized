...
(cl:defmethod cl:initialize-instance :after ((m <Move-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Move-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotiq_3f_srvs-srv:<Move-request> is deprecated: use robotiq_3f_srvs-srv:Move-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <Move-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Move-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotiq_3f_srvs-srv:<Move-response> is deprecated: use robotiq_3f_srvs-srv:Move-response instead.")))
